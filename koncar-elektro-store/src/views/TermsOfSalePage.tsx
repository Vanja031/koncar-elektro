...
const breadcrumbs = [{ label: 'Početna', href: '/' }, { label: 'Uslovi kupovine' }];

/** Content adapted from live site `/uslovi-koriscenja` + firm registry block. */
const TermsOfSalePage = () => (
  <InfoPageShell
    breadcrumbs={breadcrumbs}
    title="Uslovi kupovine"
    subtitle="Pravila pri kupovini koja obezbeđuju kvalitet naše usluge i zadovoljstvo kupaca."
  >
    <div className="prose prose-sm max-w-3xl">
      ...
      <p>
        {companyInfo.name} garantuje za kvalitet svojih proizvoda. Svi proizvodi su originalne robne
        marke i odgovaraju specifikaciji navedenoj na sajtu.
      </p>
      ...
      <p>
        ...
        odnosno deklarisanim karakteristikama kvaliteta, {companyInfo.name} će zameniti proizvod ili
        vratiti novac. Da bi se izbegli nesporazumi, prilikom isporuke dužnost prodavca i kupca je da
        izvrše pregled proizvoda i da ukažu na eventualna mehanička oštećenja, u kom slučaju će
        proizvod biti zamenjen. Detalje potražite na stranicama{' '}
      ...
      <p>
        Da bismo uspešno obradili vašu narudžbu potrebni su nam vaše ime i prezime, adresa, e-mail i
        telefon. Uz pomoć tih podataka bićemo u mogućnosti da vam isporučimo željenu robu, kao i da
        vas obavestimo o trenutnom statusu narudžbe. U ime {companyInfo.name} obavezujemo se da ćemo
        čuvati privatnost svih naših kupaca. Prikupljamo samo neophodne, osnovne podatke o kupcima i
        podatke neophodne za poslovanje i informisanje korisnika u skladu sa dobrim poslovnim
        običajima i u cilju pružanja kvalitetne usluge. Svi podaci o kupcima/korisnicima se strogo
        čuvaju i dostupni su samo zaposlenima kojima su podaci nužni za obavljanje posla. Svi
        zaposleni {companyInfo.name} odgovorni su za poštovanje načela zaštite privatnosti.
      </p>
      <p>
      ...
      <p>
        ...
        kompletni, pouzdani i bez grešaka. Ako proizvod koji ste kupili odstupa od podataka koji su
        navedeni na sajtu možete ga vratiti u nekorišćenom stanju sa kompletnom dokumentacijom koju
        ste uz njega dobili, a mi ćemo vam vratiti novac.
      </p>
      ...
      <p>
        Dostupne načine plaćanja opisujemo na stranici <a href="/nacin-placanja">Način plaćanja</a>.
        Uslove isporuke potražite na stranici <a href="/nacini-isporuke">Dostava</a>.
      </p>
